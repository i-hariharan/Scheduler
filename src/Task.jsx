      ...
      <div className="space-y-7 ">
        ...
        <div className=" w-246 rounded md:shrink-0 max-md:pl-[10px] ">
          ...
          <div className="mt-2 sm:w-[320px] sm:ml-5 sm:pl-2 rounded-xl bg-white ml-2 mr-2">
            <span>
              <p className="flex justify-center items-center pt-2 pl-2  text-primaryLight font-bold text-medium">
                My To Do List
              </p>
                ...
                <ol>
                  {stageName.map((stage, index) => (
                    <span className=" text-gray-500 font-medium text-md ">
                      <li
                        key={index}
                        className="text-gray-500 flex justify-between font-medium text-md max-md:pl-2"
                      >
                        {stage}
                        <button
